  ...
  return (
    <CalculatorLayout title="Emergency Fund" description="Calculate how much emergency fund you need" icon={Umbrella} category="planning">
      <div className="calc-inputs">
        <SliderInput label="Monthly Expenses" value={expense} onChange={setExpense} min={5000} max={500000} step={1000} prefix="₹" id="emg-expense" />
        <SliderInput label="Months of Cover" value={months} onChange={setMonths} min={3} max={12} id="emg-months" />
        <SliderInput label="Current Emergency Savings" value={current} onChange={setCurrent} min={0} max={5000000} step={5000} prefix="₹" id="emg-current" />
      </div>
