  ...
  return (
    <CalculatorLayout title="Home Loan Calculator" description="Home loan EMI with amortization schedule" icon={Building2} category="loans">
      <div className="calc-inputs">
        <SliderInput label="Loan Amount" value={principal} onChange={setPrincipal} min={100000} max={500000000} step={100000} prefix="₹" id="hl-principal" />
      ...
      <div className="calc-results">
        ...
        <ReportButton
          onGenerate={async (forName) => {
            const { generateHomeLoanReport } = await import('../../utils/pdfReport');
            await generateHomeLoanReport({ principal, rate, years, results, forName });
          }}
        />
